...
def new_entry():
	...
	can.create_oval(800+20,35+40+40, 800+20+30,35+40+30+40,fill="red",outline="red")
	can.create_oval(800+20+160-30,35+40+40, 800+20+160,35+40+30+40,fill="red",outline="red")
	can.create_rectangle(800+20+15,35+40+40, 800+20+160-15,35+40+30+40, fill="red",outline="red")

	can.create_text(800+20+80,35+40+15+40,text="Clear",font=("FreeMono",13),fill="#ffffff")
...
def create_account():
	...
	can.create_oval(x+20+30,y+yy-20-30, x+20+30+30,y+yy-20,outline="red",fill="red")
	can.create_oval(x+20+100+30-30,y+yy-20-30, x+20+100+30,y+yy-20,outline="red",fill="red")

	can.create_rectangle(x+20+30+15,y+yy-20-30, x+20+100+30-15,y+yy-20,fill="red",outline="red")



	can.create_text(x+20+30+50,y+yy-20-30+15,text="Cancel",font=("FreeMono",13),fill="#ffffff",anchor="c")
